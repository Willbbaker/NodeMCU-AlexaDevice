/*
This version was created by William Baker on 6/21/2020. 
It has been modified to compile with ArduinoJson v6. 
The original code has been left in place and commented out. 
*/ 
...
void setTargetTemperatureOnServer(String deviceId, String value, String scale) {
 ...
 // root["deviceId"] = deviceId;
 DynamicJsonDocument doc(1024);
 doc["action"] = "SetTargetTemperature";
 doc["deviceId"] = deviceId;
 ...
 JsonObject targetSetpoint = root.createNestedObject("targetSetpoint");
